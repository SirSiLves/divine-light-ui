...
export class AiDqnService {
  ...
  public static readonly ALL_DQN_SETTINGS = {
    ...
    episodes: 100000,
    epsilon: 1,
    epsilonDecay: 0.00002, // go slightly for more exploitation instead of exploration
    ...
    opponent: 'minimax', // 'random' | 'minimax' | 'hybrid'
  };
  ...
  initializeModel(godType: GodType) {
    switch (AiDqnService.EXTENSION_SETTING) {
      ...
      case 5: {
        this.aiDqn5Service.initializeModel(godType);
        break;
      }
    }
  }
  ...
  downloadDQNModel(godType: GodType): void {
    switch (AiDqnService.EXTENSION_SETTING) {
      ...
      case 5: {
        const model = this.aiDqn5Service.getModel(godType);
        model.save('downloads://' + (
          godType === GodType.CAMAXTLI ? AiDqn5Service.DQN_SETTINGS.files.camaxtli.model : AiDqn5Service.DQN_SETTINGS.files.nanahuatzin.model
        )); // https://www.tensorflow.org/js/guide/save_load
        break;
      }
    }
  ...
  downloadDQNLoss(isTraining: GodType): void {
    switch (AiDqnService.EXTENSION_SETTING) {
      ...
      case 4:
        ...
        break;
      case 5:
        this.aiDqn5Service.downloadLoss(isTraining);
        break;
    }
  }
  ...
  downloadProgress(isTraining: GodType): void {
    switch (AiDqnService.EXTENSION_SETTING) {
      ...
      case 4:
        ...
        break;
      case 5:
        this.aiDqn5Service.downloadProgress(isTraining);
        break;
    }
  }
}
